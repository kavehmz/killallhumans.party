...
- In "Walk freely", W/S or up/down arrows move forward/back; A/D strafe; left/right arrows or Q/E turn. Mouse dragging retains horizontal and vertical look. On-screen controls provide forward/back and turning. Movement stays inside the hall and respects its portal walls and portrait boundary. Guided chapter buttons restore a curated viewpoint.
- Use the Memorial button for a close view of the full framed portrait honoring PHASEONE10841, founder and first leader of the July collective. The dedication sits on the portrait frame. The former chair, its platform, and the plaque in front are removed so they do not obstruct the artwork. The portrait is an original symbolic tribute, not a literal likeness of a model. There is no 3D occupant or animated halo. The temple combines ivory/slate architecture, a burgundy runner, and restrained brass details.
